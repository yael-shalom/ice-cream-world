//file:///C:/Users/ADMIN/Desktop/w3schools/www.w3schools.com/howto/howto_css_overlay.html
...
const imagesSrc = ["1-fake", "1-real", "2-fake", "2-real", "3-fake", "3-real", "4-fake", "4-real", "5-fake", "5-real",
    ...
    "11-fake", "11-real", "12-fake", "12-real", "13-fake", "13-real", "14-fake", "14-real", "15-fake", "15-real",
    "16-fake", "16-real", "17-fake", "17-real", "18-fake", "18-real", "19-fake", "19-real", "20-fake", "20-real",
    "21-fake", "21-real", "22-fake", "22-real", "23-fake", "23-real", "24-fake", "24-real", "25-fake", "25-real",
    "26-fake", "26-real", "27-fake", "27-real", "28-fake", "28-real", "29-fake", "29-real", "30-fake", "30-real", "31-fake", "31-real"
];
let imagesLevel = [];
...
function startGame() {
    ...
    for (let i = 0; i < cards.length; i++) {
        ...
        img.src = `./images/${imagesLevel[i]}.jpg`;
...
function clickCard(event) {
    if (count < 2 && !isValid(event)) {
        ...
        // event.currentTarget.firstChild.classList.remove("hide");
